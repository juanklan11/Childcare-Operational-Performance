...
export default function NEPIAuditDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
      {/* page header — replace or tweak inside BrandHeader */}
      <BrandHeader
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="portfolio">
            <div className="rounded-3xl border bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-slate-600">Sample data showing centre-level performance. Replace with live data from your API/JSON.</p>
